...
import com.linecorp.healthcare.survey.condition.CodeCondition;
import com.linecorp.healthcare.survey.condition.Condition;
import com.linecorp.healthcare.survey.condition.DoubleCondition;
import com.linecorp.healthcare.survey.condition.TextCondition;
import com.linecorp.healthcare.survey.questionnaire.domain.answer.descision.CodeFactorModifier;
import com.linecorp.healthcare.survey.questionnaire.domain.answer.descision.DoubleFactorModifier;
import com.linecorp.healthcare.survey.questionnaire.domain.answer.descision.FactorModifier;
import com.linecorp.healthcare.survey.questionnaire.domain.answer.descision.TextFactorModifier;
import com.linecorp.healthcare.survey.questionnaire.domain.factor.CodeFactor;
import com.linecorp.healthcare.survey.questionnaire.domain.factor.DoubleFactor;
